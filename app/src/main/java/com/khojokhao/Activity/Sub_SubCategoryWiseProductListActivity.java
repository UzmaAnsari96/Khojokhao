...
public class Sub_SubCategoryWiseProductListActivity extends AppCompatActivity {
...
//        from = getIntent().getStringExtra("from");
    ...
    private void init() {
        dialog = new IOSDialog.Builder(Sub_SubCategoryWiseProductListActivity.this)
        ...
        rec_list.setLayoutManager(new LinearLayoutManager(Sub_SubCategoryWiseProductListActivity.this));
        rec_subcategory.setLayoutManager(new LinearLayoutManager(Sub_SubCategoryWiseProductListActivity.this, RecyclerView.HORIZONTAL, false));
    }
...
//                getSubCategoryList();
                Intent intent = new Intent(Sub_SubCategoryWiseProductListActivity.this, SubSubCategoryListActivity.class);
            ...
            public void onClick(View v) {
              ...
              /*  if(subscription_type.equals("customize")){
                ...
                if (strFromDate.equals("")) {
                    Toast.makeText(Sub_SubCategoryWiseProductListActivity.this, "Please select from date", Toast.LENGTH_SHORT).show();
                } else if (strToDate.equals("")) {
                    Toast.makeText(Sub_SubCategoryWiseProductListActivity.this, "Please select to date", Toast.LENGTH_SHORT).show();
                } else {
                    if (subscription_type.equals("Weekly")) {
                        if (weeklyDays.equals("")) {
                            Toast.makeText(Sub_SubCategoryWiseProductListActivity.this, "Please select day", Toast.LENGTH_SHORT).show();
                        } else {
//                            subscribed();
                            Intent intent = new Intent(Sub_SubCategoryWiseProductListActivity.this, SubscriptionAddressActivity.class);
                        ...
                        if (customizeDay.equals("")) {
                            Toast.makeText(Sub_SubCategoryWiseProductListActivity.this, "Please select days", Toast.LENGTH_SHORT).show();
                        } else {
//                            subscribed();
                            Intent intent = new Intent(Sub_SubCategoryWiseProductListActivity.this, SubscriptionAddressActivity.class);
                            intent.putExtra("from_date", strFromDate);
...
//
        ...
        rel_from.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                final DatePickerDialog datePickerDialog = new DatePickerDialog(Sub_SubCategoryWiseProductListActivity.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
        ...
        rel_home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(Sub_SubCategoryWiseProductListActivity.this, HomeActivity.class));
        ...
        rel_search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(Sub_SubCategoryWiseProductListActivity.this, SearchActivity.class));
//                finish();
            }
        });
        ...
        rel_cart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(Sub_SubCategoryWiseProductListActivity.this, CartActivity.class));
            }
        });
        ...
        rel_subscription.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(Sub_SubCategoryWiseProductListActivity.this, SubscriptionActivity.class));
            }
        });
        ...
        rel_account.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(Sub_SubCategoryWiseProductListActivity.this, AccountActivity.class));
            }
        });
    ...
    /*public void subscribed() {
        dialog.show();
        if (APIURLs.isNetwork(Sub_SubCategoryWiseProductListActivity.this)) {
            StringRequest stringRequest = new StringRequest(Request.Method.POST, APIURLs.my_subscription, new Response.Listener<String>() {
                ...
                public void onResponse(String response) {
                    try {
                        ...
                        if (status.equals("1")) {
                            Toast.makeText(Sub_SubCategoryWiseProductListActivity.this, jsonObject1.getString("msg"), Toast.LENGTH_SHORT).show();
                            subsQty = 0;
                            getProductList();
                            card_mySubscription.setVisibility(View.GONE);
                            lin_day.setVisibility(View.GONE);
                ...
                protected Map<String, String> getParams() throws AuthFailureError {
                    *//*if(subscription_type.equals("customize")){
                    ...
                    params.put("customer_id", SharedPref.getVal(Sub_SubCategoryWiseProductListActivity.this, SharedPref.customer_id));
                    params.put("from_date", strFromDate);
                    params.put("to_date", strToDate);
                    params.put("subscribe_mode", subscription_type);
                    params.put("product_id", strProductId);
                    params.put("qty", strQty);
                    if (subscription_type.equals("Custom")) {
                        params.put("day", customizeDay);
                    } else if (subscription_type.equals("Weekly")) {
                        params.put("day", weeklyDays);
                    }
                    return params;
                }
            };
            ...
            dismissDialog();
            FunctionConstant.noInternetDialog(Sub_SubCategoryWiseProductListActivity.this, "no internet connection");
        }
    ...
    public void getsubsubProductList() {
        dialog.show();
                    ...
                    try {
                        ...
                        if (status.equals("1")) {
                          ...
                          /*  productId = new ArrayList<>();
                            ...
                            adapter = new ProductAdapter(Sub_SubCategoryWiseProductListActivity.this);
...
//                            rec_list.setHasFixedSize(true);
                ...
                protected Map<String, String> getParams() throws AuthFailureError {
                    ...
                    params.put("customer_id", SharedPref.getVal(Sub_SubCategoryWiseProductListActivity.this, SharedPref.customer_id));
                    params.put("franchise_id", SharedPref.getVal(Sub_SubCategoryWiseProductListActivity.this, SharedPref.fran_code));
                    return params;
                }
            };
    ...
    public class ProductAdapter extends RecyclerView.Adapter<ProductAdapter.ViewHolder> {
        ...
        public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(Sub_SubCategoryWiseProductListActivity.this).inflate(R.layout.search_item_layout, parent, false);
        ...
        public class ViewHolder extends RecyclerView.ViewHolder {
            ...
            public void bind(final ProductModel model, final int position) {
                Glide.with(Sub_SubCategoryWiseProductListActivity.this).load(model.getImage()).into(img_product);
...
*/
                ...
                lnr_product.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent(new Intent(Sub_SubCategoryWiseProductListActivity.this, ProductDetailsActivity.class));
            ...
            public void removeCart(final String product_id, final int position) {
                ...
                if (APIURLs.isNetwork(Sub_SubCategoryWiseProductListActivity.this)) {
                        ...
                        public void onResponse(String response) {
                            try {
                                ...
                                if (status.equals("1")) {
                                    ...
                                    Toast.makeText(Sub_SubCategoryWiseProductListActivity.this, "Error", Toast.LENGTH_SHORT).show();
                                }
                                dismissDialog();
                            } catch (JSONException e) {
                                dismissDialog();
                    ...
                    RequestQueue requestQueue = Volley.newRequestQueue(Sub_SubCategoryWiseProductListActivity.this);
                    stringRequest.setRetryPolicy(new DefaultRetryPolicy(50000, DefaultRetryPolicy.DEFAULT_MAX_RETRIES,
                            DefaultRetryPolicy.DEFAULT_BACKOFF_MULT));
                    requestQueue.add(stringRequest);
                } else {
