...
public class CouponListActivity extends AppCompatActivity {
    ...
    private void init() {
        dialog = new IOSDialog.Builder(CouponListActivity.this)
        ...
        rec_coupon.setLayoutManager(new LinearLayoutManager(CouponListActivity.this));
    }
    ...
    public void getCouponList() {
        dialog.show();
        if (APIURLs.isNetwork(CouponListActivity.this)) {
            StringRequest stringRequest = new StringRequest(Request.Method.POST, APIURLs.COUPONLIST_URL, new Response.Listener<String>() {
                    ...
                    try {
                        ...
                        if (status.equals("1")) {
                            ...
                            if(jsonObject.has("result")) {
                                ...
                                CouponAdapter adapter = new CouponAdapter(CouponListActivity.this);
                ...
                protected Map<String, String> getParams() throws AuthFailureError {
                    ...
                    params.put("customer_id", SharedPref.getVal(CouponListActivity.this, SharedPref.customer_id));
                    params.put("franchise_id",SharedPref.getVal(CouponListActivity.this, SharedPref.fran_code));
                    return params;
                }
            };
            ...
            dismissDialog();
            FunctionConstant.noInternetDialog(CouponListActivity.this, "no internet connection");
        }
    }
    ...
    public class CouponAdapter extends RecyclerView.Adapter<CouponAdapter.ViewHolder> {
        ...
        public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(CouponListActivity.this).inflate(R.layout.coupon_item_layout, parent, false);
