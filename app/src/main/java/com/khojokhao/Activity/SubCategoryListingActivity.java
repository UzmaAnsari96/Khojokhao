    ...
    private void onClick() {
        ...
        rel_search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(SubCategoryListingActivity.this, SearchActivity.class));
//                    finish();
            }
        });
        ...
        rel_cart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(SubCategoryListingActivity.this, CartActivity.class));
            }
        });
    ...
    private void init() {
        ...
        rec_list.setLayoutManager(new GridLayoutManager(SubCategoryListingActivity.this, 2));
        ...
        if (APIURLs.isNetwork(SubCategoryListingActivity.this)) {
            StringRequest stringRequest = new StringRequest(Request.Method.POST, APIURLs.SUBCATEGORY_URL, new Response.Listener<String>() {
                ...
                protected Map<String, String> getParams() throws AuthFailureError {
                    ...
                    params.put("franchise_id", SharedPref.getVal(SubCategoryListingActivity.this, SharedPref.fran_code));
