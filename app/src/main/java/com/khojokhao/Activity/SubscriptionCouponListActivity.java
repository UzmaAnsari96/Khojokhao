...
public class SubscriptionCouponListActivity extends AppCompatActivity {
    ...
    private void init() {
        dialog = new IOSDialog.Builder(SubscriptionCouponListActivity.this)
        ...
        rec_coupon.setLayoutManager(new LinearLayoutManager(SubscriptionCouponListActivity.this));
    }
    ...
    public void getCouponList() {
        dialog.show();
        if (APIURLs.isNetwork(SubscriptionCouponListActivity.this)) {
            StringRequest stringRequest = new StringRequest(Request.Method.POST, APIURLs.SUBSCRIPTION_COUPONLIST_URL, new Response.Listener<String>() {
                @Override
                    ...
                    try {
                        ...
                        if (status.equals("1")) {
                            ...
                            if(jsonObject.has("result")) {
                                ...
                                CouponAdapter adapter = new CouponAdapter(SubscriptionCouponListActivity.this);
                ...
                protected Map<String, String> getParams() throws AuthFailureError {
                    ...
                    params.put("customer_id", SharedPref.getVal(SubscriptionCouponListActivity.this, SharedPref.customer_id));
                    params.put("franchise_id",SharedPref.getVal(SubscriptionCouponListActivity.this, SharedPref.fran_code));
                    return params;
                }
            };
            ...
            dismissDialog();
            FunctionConstant.noInternetDialog(SubscriptionCouponListActivity.this, "no internet connection");
        }
    }
    ...
    public class CouponAdapter extends RecyclerView.Adapter<CouponAdapter.ViewHolder> {
        ...
        public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(SubscriptionCouponListActivity.this).inflate(R.layout.coupon_item_layout, parent, false);
