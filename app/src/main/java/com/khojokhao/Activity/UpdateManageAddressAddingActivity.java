...
public class UpdateManageAddressAddingActivity extends AppCompatActivity {
...
//        }
    ...
    private void setData(AddressModel model) {
        edt_flatno.setText(model.getFlat_no());
        edt_bldgName.setText(model.getBuilding_name());
    ...
    private void init() {
        dialog = new IOSDialog.Builder(UpdateManageAddressAddingActivity.this)
    ...
    public void updateAddress(){
        dialog.show();
        if (APIURLs.isNetwork(UpdateManageAddressAddingActivity.this)) {
            StringRequest stringRequest = new StringRequest(Request.Method.POST, APIURLs.customer_address_update, new Response.Listener<String>() {
                ...
                public void onResponse(String response) {
                    try {
                        ...
                        if (status.equals("1")) {
                            Toast.makeText(UpdateManageAddressAddingActivity.this, jsonObject1.getString("msg"), Toast.LENGTH_SHORT).show();
                            startActivity(new Intent(UpdateManageAddressAddingActivity.this,AccountManageAddressActivity.class));
                            finish();
                            /*if(from.equals("subs")){
                                Intent intent = new Intent(UpdateManageAddressAddingActivity.this,SubscriptionAddressActivity.class);
                                ...
                                Intent intent = new Intent(UpdateManageAddressAddingActivity.this,AddressActivity.class);
                                intent.putExtra("product_id",product_id);
                            ...
                            Toast.makeText(UpdateManageAddressAddingActivity.this, "Error", Toast.LENGTH_SHORT).show();
                        }
                        dismissDialog();
                ...
                protected Map<String, String> getParams() throws AuthFailureError {
                    ...
                    params.put("sector_number", edt_sector.getText().toString());
                    params.put("pincode", edt_pincode.getText().toString());
                    return params;
                }
            };

            RequestQueue requestQueue = Volley.newRequestQueue(UpdateManageAddressAddingActivity.this);
            stringRequest.setRetryPolicy(new DefaultRetryPolicy(50000, DefaultRetryPolicy.DEFAULT_MAX_RETRIES,
                    DefaultRetryPolicy.DEFAULT_BACKOFF_MULT));
            requestQueue.add(stringRequest);
        } else {
            dismissDialog();
            FunctionConstant.noInternetDialog(UpdateManageAddressAddingActivity.this, "no internet connection");
        }
    }
        ...
        if (APIURLs.isNetwork(UpdateManageAddressAddingActivity.this)) {
            StringRequest stringRequest = new StringRequest(Request.Method.POST, APIURLs.check_pincode, new Response.Listener<String>() {
                ...
                public void onResponse(String response) {
                    try {
                        ...
                        if(status.equals("0")){
                            ...
                            new AlertDialog.Builder(UpdateManageAddressAddingActivity.this)
                                    .setTitle("Service unavailable")
                ...
                protected Map<String, String> getParams() throws AuthFailureError {
                    ...
                    params.put("franchise_id", SharedPref.getVal(UpdateManageAddressAddingActivity.this, SharedPref.fran_code));
                    return params;
                }
            };
