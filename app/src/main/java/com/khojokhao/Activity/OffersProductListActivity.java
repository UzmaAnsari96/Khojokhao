...
//                            rec_list.setHasFixedSize(true);
                ...
                protected Map<String, String> getParams() throws AuthFailureError {
                    ...
                    params.put("franchise_id", SharedPref.getVal(OffersProductListActivity.this, SharedPref.fran_code));
    ...
    public class ProductAdapter extends RecyclerView.Adapter<ProductAdapter.ViewHolder> {
        ...
        public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(OffersProductListActivity.this).inflate(R.layout.search_item_layout, parent, false);
...
//                rel_subs.setVisibility(View.GONE);
            ...
            public void bind(final ProductModel model, final int position) {
                Glide.with(OffersProductListActivity.this).
                        load(model.getImage()).into(img_product);
...
//                        }
                ...
                lnr_product.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent(new Intent(OffersProductListActivity.this, ProductDetailsActivity.class));
